...
public class WebcamExampleTesting
{
    //----------------------------------------------------------------------------------------------
    // Main
    //----------------------------------------------------------------------------------------------
            ...
            @Override public void onConfigured(@NonNull CameraCaptureSession session)
            {
                try {
                    ...
                    CameraCaptureSequenceId cameraCaptureSequenceId = session.startCapture(cameraCaptureRequest,
                            new OneCameraExample.WebcamExampleCaptureCallback(cameraCaptureRequest), // callback, not continuation; avoids copying frame
